...
From: ./generate.rb @ line 9 :

     4: require 'erb'
     5: require 'date'
     6: require 'yaml'
     7: 
     8: bio_gems = YAML.load(File.open('bio-gems.yml', 'rb'))
 =>  9: binding.irb
    10: 
    11: puts '## The List of Bio Gems'
    12: puts
    13: puts '* https://github.com/ruby-on-bioc/bio-gems'
    14: puts
